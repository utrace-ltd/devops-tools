...
RUN curl -L https://github.com/utrace-ltd/jira-release-updater/releases/download/RC1-0.1.0/jira-release-updater_linux_amd64 > /usr/local/bin/jira-release-updater \
